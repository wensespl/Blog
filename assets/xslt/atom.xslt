...
<xsl:template match="/atom:feed">
	...
	<meta name="description" content="This is my personal blog where you can find all my projects.">
	...
	<meta property="og:description" content="This is my personal blog where you can find all my projects.">
	...
	<meta name="twitter:description" content="This is my personal blog where you can find all my projects.">
...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000/Blog" class="icon-tree"> Blog</a></h1>
    </li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/Blog/" title="Blog – A place where you can find my projects.">
				<img src="http://localhost:4000/Blog/assets/img/logo.png" alt="Blog – A place where you can find my projects.">
			</a>
        ...
        <div class="row">
          <div class="medium-6 large-5 columns">
            ...
            <p class="shadow-black">
              This is my personal blog where you can find all my projects.
      ...
      <div id="subfooter">
        <nav class="row">
          <section id="subfooter-left" class="small-12 medium-6 columns credits">
            <p>Created with &hearts; by <a href="">Wenses Penadillo</a> with <a href="http://jekyllrb.com/" target="_blank">Jekyll</a>.</p>
          </section>

          <section id="subfooter-right" class="small-12 medium-6 columns">
            <ul class="inline-list social-icons">
            
              <li><a href="https://github.com/wencez432" target="_blank" class="icon-github" title="wencez432"></a></li>
            
              <li><a href="http://www.youtube.com/PhlowMedia" target="_blank" class="icon-youtube" title="wencez432"></a></li>
            
              <li><a href="http://twitter.com/phlow" target="_blank" class="icon-twitter" title="wencez432"></a></li>
